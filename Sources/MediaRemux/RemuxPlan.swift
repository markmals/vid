...
public struct RemuxPlan: MediaOperationPlan {
    ...
    public let settings: RemuxSettings

    /// Creates a remux operation plan.
    public init(outputFilenameSuffix: String, settings: RemuxSettings) {
