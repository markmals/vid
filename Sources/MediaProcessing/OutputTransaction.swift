...
public struct OutputPolicy: Sendable {
    ...
    public let shouldOverwriteExistingOutput: Bool
    /// Whether the source file should be removed after a successful commit.
    public let shouldRemoveSource: Bool
    ...
    public let shouldReplaceInput: Bool

    /// Creates a resolved media output policy.
    public init(
        outputDirectory: URL?,
        shouldOverwriteExistingOutput: Bool,
        shouldRemoveSource: Bool,
        shouldReplaceInput: Bool
    ) {
        self.outputDirectory = outputDirectory
        self.shouldOverwriteExistingOutput = shouldOverwriteExistingOutput
        self.shouldRemoveSource = shouldRemoveSource
        self.shouldReplaceInput = shouldReplaceInput
    }
}
...
/// is abandoned.
public struct OutputTransaction: Sendable {
    ...
    public init(
        ...
        if let outputDirectory = policy.outputDirectory {
            ...
            guard
                ...
                throw MediaProcessingError.invalidOutputDirectory(path: outputDirectory.path)
            }
        }
