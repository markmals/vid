...
public enum FFmpegPlanSupport {
    ...
    /// - Throws: ``MediaProcessingError/noVideoStream(path:)`` when `probe`
    ///   contains no video stream.
    public static func requiredVideoStream(
        in probe: MediaProbe,
        input: URL
    ) throws -> MediaStream {
        guard let video = probe.firstVideoStream else {
            throw MediaProcessingError.noVideoStream(path: input.path)
        }
        return video
    }
    ...
    public static func subtitleStreams(
        in probe: MediaProbe,
    ...
    public static func bitmapSubtitles(
        in probe: MediaProbe,
        handling: SubtitleHandling,
    ) -> [MediaStream] {
        switch handling {
    ...
    public static func bitmapSubtitleExtractions(
        in probe: MediaProbe,
        handling: SubtitleHandling,
        input: URL
    ...
    public static func appendAudioEncoding(
    ...
    public static func appendAudioTags(
    ...
    public static func appendSubtitleOutputOptions(
